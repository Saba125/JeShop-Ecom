                            ...
                            {products?.data?.map((product) => {
                                ...
                                return (
                                    <Card
                                        ...
                                        style={{
                                            // KEY: flex-shrink:0 + explicit width as % of container
                                            // calc(25% - 12px): 4 cards * 25% = 100%, minus (3 gaps * 16px / 4 cards) = 12px
                                            // This % is relative to the FLEX CONTAINER (trackRef div),
                                            // NOT the viewport — so sidebar doesn't affect it
                                            flex: '0 0 calc(25% - 12px)',
                                            minWidth: '0',
                                            scrollSnapAlign: 'start',
                                        }}
                                        className="cursor-pointer relative overflow-hidden border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl group"
                                    ...
                                    >
                                        ...
                                        <div className="relative h-40 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 overflow-hidden">
                                            {activeSale && discountPercent > 0 && (
                                                <div className="absolute top-0 left-0 z-10">
                                                    <div className="bg-gradient-to-br from-primary to-primary/80 text-white px-3 py-1.5 rounded-br-2xl shadow-lg">
                                            ...
                                            {activeSale && (
                                                <div className="absolute top-2 right-2 z-10">
                                                    <Badge className="bg-primary text-white shadow text-[9px] px-1.5 py-0.5">
                                            ...
                                            <div
                                                className={`absolute ${
                                                    activeSale && discountPercent > 0
                                                        ? 'top-14'
                                                        : 'top-2'
                                                } right-2 z-10 flex flex-col gap-1.5 transition-all duration-300 ${
                                                    isHovered
                                        ...
                                        <CardContent className="p-3">
                                            ...
                                            <Button
                                                className="w-full h-8 text-xs group/btn relative overflow-hidden"
                                                size="sm"
                                                disabled={!inStock}
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                            ...
                                            <div
                                                className={`mt-2 pt-2 border-t transition-all duration-300 overflow-hidden ${
                                                    isHovered
