            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-5">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-sm">
                            საქართველოს წამყვანი გეიმინგ აქსესუარების მაღაზია. ჩვენ გთავაზობთ მხოლოდ
                            ორიგინალურ პროდუქტებს საუკეთესო ფასებად.
                        </p>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="text-sm text-muted-foreground text-center md:text-left">
                        © 2025 <span className="font-semibold text-foreground">Jeshop</span>. ყველა
                        უფლება დაცულია.
                    </div>
